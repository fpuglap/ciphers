...
const Cipher = () => {
  ...
  return (
    <>
      <input
        className='flex justify-center items-center w-6/12 h-20 text-4xl px-5 py-2 rounded-md border focus:outline-none focus:ring focus:border-blue-500 border-gray-300 bg-gray-100 dark:border-neutral-700 dark:bg-neutral-600 dark:bg-opacity-30 leading-tight'
        type='text'
