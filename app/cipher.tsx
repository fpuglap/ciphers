...
const Cipher = () => {
  ...
  return (
    <div className='flex z-10 w-full max-w-6xl justify-center items-center mt-10 mb-96'>
      <div className='flex flex-col w-full justify-center items-center'>
        ...
        <article className='mx-8'>
          <section className='indent-8 my-3 text-left w-full text-lg lg:max-w-4xl'>
            Cryptography is the science (and art) of writing messages that no
            one but the intended receiver can read. The name derives from either
            the French word cryptographie or from Modern Latin cryptographia
            both of which find their roots in the Greek <em>kryptos</em>{' '}
            “hidden” + <em>graphia</em> “writing or recording”.
          </section>
          <section className='my-3 w-full text-left text-lg from-zinc-200 pb-2 dark:from-inherit lg:max-w-4xl lg:static lg:w-auto lg:rounded-xl mx-auto'>
            ...
            hiding messages from unauthorized people until the message reaches
            the intended hand. The first evidence of cryptography is the use of
          ...
          <section className='my-3 w-full text-left text-lg from-zinc-200 pb-2 dark:from-inherit lg:max-w-4xl lg:static lg:w-auto lg:rounded-xl mx-auto'>
            ...
            message would shift the letters by the same number again to obtain
          ...
          <section className='my-3 w-full text-left text-lg from-zinc-200 pb-2 dark:from-inherit lg:max-w-4xl lg:static lg:w-auto lg:rounded-xl mx-auto'>
            ...
            <br />
            <br />
            To cipher this phrase using Caesar method one would shift each
            letter up in the alphabet. <br />
